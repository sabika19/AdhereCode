<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewProfile.aspx.cs" Inherits="MyWebsite.ViewProfile" %>
            ...
            <i class="fa fa-dashboard"></i> <span>User Profile</span>
             ...
             <li><a href="UploadNotes.aspx"><i class="fa fa-circle-o"></i> <span>Upload Notes</span></a></li>
              <li><a href="YourCart.aspx"><i class="fa fa-circle-o"></i> <span>My Cart</span></a></li>
               <li><a href="MyNotes.aspx"><i class="fa fa-circle-o"></i> My Notes</a></li>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <%--  <img class="profile-user-img img-responsive img-circle" src="../../dist/img/user4-128x128.jpg" alt="User profile picture">--%>
               <img id="img1" runat="server" class="profile-user-img img-responsive img-circle" alt="User profile picture" />
              <h3 class="profile-username text-center"><asp:Label ID="lblname11" runat="server"></asp:Label></h3>

              <p class="text-muted text-center"><asp:Label ID="lblprof" runat="server"></asp:Label></p>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Notes Uploaded</b> <a class="pull-right">543</a>
                </li>
              </ul>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted"><asp:Label ID="lbladd" runat="server"></asp:Label></p>
              ...
              <p>
                <span class="label label-danger"><asp:Label ID="lblskill1" runat="server"></asp:Label></span>
                <span class="label label-success"><asp:Label ID="lblskill2" runat="server"></asp:Label></span>
                <span class="label label-info"><asp:Label ID="lblskill3" runat="server"></asp:Label></span>
                <span class="label label-warning"><asp:Label ID="lblskill4" runat="server"></asp:Label></span>
                <span class="label label-primary"><asp:Label ID="lblskill5" runat="server"></asp:Label></span>
              </p>

              <hr>

              <strong><i class="fa fa-file-text-o margin-r-5"></i> Brief Bio</strong>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Notes By <asp:Label ID="lblname111" runat="server"></asp:Label></a></li>
