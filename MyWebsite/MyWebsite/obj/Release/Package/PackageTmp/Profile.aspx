...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-mini"><b>A</b>dhere</span>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"> <asp:Label ID="Label2" runat="server" Font-Bold="true"></asp:Label></span>
            </a>
...
<%--                  <input type="text" class="form-control" placeholder="ADDRESS LINE 1 ...">--%>
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" runat="server" id="slctstate" style="width: 100%;">
             ...
             <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <asp:TextBox class="form-control pull-right" id="datepicker" runat="server"></asp:TextBox>
			  ...
			  <label for="exampleInputFile">UPLOAD/UPDATE PROFILE PIC</label>
                ...
                <br />
                <br />
                <asp:Button ID="btnpic" runat="server" class="alert-info" Text="CHANGE PHOTO" />
        ...
        <div class="col-md-12">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Stroke Screening Form</h3>
            </div>
            <div class="box-body">
              <!-- Date dd/mm/yyyy -->
              <div class="form-group">
               ...
               <div class="bootstrap-timepicker">
                ...
                <label>Have you received on health-related lifestyle changes to prevent another stroke?</label>
                  <br />        <input type="checkbox" id="Checkbox1" class="flat-red" runat="server" value="Y" >YES</input>
                       <input type="checkbox" id="Checkbox2" class="flat-red" runat="server" value="N" >NO</input>
              </div>
                  <div class="form-group">
                <label>Are you finding it more difficult to take care of yourself?</label>
                    <br />      <input type="checkbox" id="Checkbox3" class="flat-red" runat="server" value="Y" >YES</input>
                       <input type="checkbox" id="Checkbox4" class="flat-red" runat="server" value="N" >NO</input>
              </div>
                  <div class="form-group">
                <label>Are you finding it difficult to walk or move safely (i.e., from bed to chair)?</label>
                    <br />      <input type="checkbox" id="Checkbox5" class="flat-red" runat="server" value="Y" >YES</input>
                       <input type="checkbox" id="Checkbox6" class="flat-red" runat="server" value="N" >NO</input>
              </div>
                  <div class="form-group">
                <label>Do you have increased stiffness in your arms, hands, or legs?</label>
                    <br />      <input type="checkbox" id="Checkbox7" class="flat-red" runat="server" value="Y" >YES</input>
                       <input type="checkbox" id="Checkbox8" class="flat-red" runat="server" value="N" >NO</input>
              </div>
                   <div class="form-group">
                <label>Do you have any pain?</label>
                     <br />     <input type="checkbox" id="Checkbox9" class="flat-red" runat="server" value="Y" >YES</input>
                       <input type="checkbox" id="Checkbox10" class="flat-red" runat="server" value="N" >NO</input>
              </div>
                   <div class="form-group">
                <label>Are you finding it more difficult to carry out leisure activities, hobbies or work?</label>
                      <br />    <input type="checkbox" id="Checkbox11" class="flat-red" runat="server" value="Y" >YES</input>
                       <input type="checkbox" id="Checkbox12" class="flat-red" runat="server" value="N" >NO</input>
              </div>
                  <div class="form-group">
                <label>Are you experiencing fatigue that is interfering with your ability to do your exercises or other activities?</label>
                    <br />   <input type="checkbox" id="Checkbox13" class="flat-red" runat="server" value="Y" >YES</input>
                       <input type="checkbox" id="Checkbox14" class="flat-red" runat="server" value="N" >NO</input>
              </div>
...
<%--<input type="text" class="form-control" placeholder="ENTER TOPIC...">--%>
      ...
      <asp:Button ID="btnSave" runat="server" class="btn btn-block btn-danger btn-lg" 
 ...
 <%--<button type="button" class="btn btn-block btn-danger btn-lg">SAVE CHANGES</button>--%>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016 <a href="Default.aspx">Notes Cart</a>.</strong> All rights
    reserved.
  </footer>
