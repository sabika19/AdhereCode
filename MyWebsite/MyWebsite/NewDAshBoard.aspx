           ...
           <li><a href="Profile.aspx"><i class="fa fa-circle-o"></i> <span>Profile</span></a></li>
             <li><a href="MyEx.aspx"><i class="fa fa-circle-o"></i> <span>My Excercises</span></a></li>
              <li><a href="Mycom.aspx"><i class="fa fa-circle-o"></i> <span>My Community</span></a></li>
                <li><a href="Feedback.aspx"><i class="fa fa-circle-o"></i>Messages<asp:Image runat="server" ID="imgmsg" with="20px" Height="20px" ImageUrl="images/message.png" /></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
             <div class="col-md-12" align="center">
                  ...
                  <div class="col-md-12">
	<iframe src="http://localhost:52564/admin/admntools/dbvideo.mp4" frameborder="0" width="900" height="600" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
             </div>
