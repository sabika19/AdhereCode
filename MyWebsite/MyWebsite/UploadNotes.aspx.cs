...
namespace MyWebsite
{
    public partial class UploadNotes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Page.IsPostBack)
            {
                Session["subject"] = Request.Form["Select2"];
                string x1 = Session["subject"].ToString();
                string x2 = x1;
            }
         
            if (!IsPostBack)
            {
                imguser1.Src = "profile/" + Session["username"].ToString() + ".jpg";
        ...
        protected void btnNote_Click(object sender, EventArgs e)
        {
            ...
            string sub_tag = Session["subject"].ToString();
            ...
            {
                lblmsg.Text = "PLEASE UPLOAD PDF ONLY.";
                lblmsg.Visible = true;
                return;
            }
            int slno = 0;
