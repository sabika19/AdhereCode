<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Feedback.aspx.cs" Inherits="MyWebsite.Feedback" %>
            ...
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
             ...
             <li ><a href="MyEx.aspx"><i class="fa fa-circle-o"></i> <span>My Excercises</span></a></li>
              <li ><a href="MyCom.aspx"><i class="fa fa-circle-o"></i> <span>My Community</span></a></li>
                <li class="active"><a href="Feedback.aspx"><i class="fa fa-circle-o"></i>Messages</a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="timeline">
            ...
            <li class="time-label">
                  <span class="bg-red">
                    <asp:Label ID="lbltimemsg" runat="server" CssClass="label"></asp:Label>
                  </span>
            </li>
            <!-- /.timeline-label -->
            <!-- timeline item -->
            <li>
              ...
              <div class="timeline-item">
                <span class="time"><i class="fa fa-clock-o"></i> <asp:Label ID="lbltimenow" runat="server" CssClass="label"></asp:Label></span>

                <h3 class="timeline-header"><a href="#"><asp:Label ID="lblsender" runat="server" CssClass="label"></asp:Label></a> sent you a message</h3>

                <div class="timeline-body">
                 <asp:Label ID="lblmsg" runat="server" CssClass="label"></asp:Label>
                </div>
               <div class="timeline-footer">
                  <a class="btn btn-primary btn-xs">Reply</a>
