...
<asp:GridView ID="grdpat" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="false"  onrowcommand="grdpat_RowCommand" OnSelectedIndexChanged="grdpat_SelectedIndexChanged">
    <Columns>
        <asp:TemplateField  HeaderText="SLNO" itemstyle-wrap="true">
            ...
            <asp:TemplateField HeaderText="NAME/GENDER/DOB">
                    <ItemTemplate>
                                          <asp:Label ID="lblname" runat="server" Text= '<%#Eval("name") %>'></asp:Label>/<br />
                        <asp:Label ID="lblgen" runat="server" Text='<%#Eval("gen").ToString() == "M" ? "Male" : "Female" %>'></asp:Label>/
                    <br />
          ...
          <asp:TemplateField HeaderText="STROKE SIDE">
                    <ItemTemplate>
                        <asp:Label ID="lblstr" runat="server" Text='<%#Eval("side").ToString() == "R" ? "Right" : "Left" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
          <asp:TemplateField HeaderText="DURATION OF STROKE(MONTHS)">
                    <ItemTemplate>
                        <asp:Label ID="lblstrmnth" runat="server" Text='<%#Eval("dur_stroke") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
         <asp:TemplateField HeaderText="SECONDARY PREVENTION">
                    <ItemTemplate>
                        <asp:Label ID="lblsecprev" runat="server" Text='<%#Eval("sec_prev").ToString() == "Y" ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
      
         <asp:TemplateField HeaderText="ACTIVITIES OF DAILY LIVING (ADL)">
                    <ItemTemplate>
                        <asp:Label ID="lblact" runat="server" Text='<%#Eval("adl").ToString() == "Y" ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
          <asp:TemplateField HeaderText="MOBILITY">
                    <ItemTemplate>
                        <asp:Label ID="lblmobi" runat="server" Text='<%#Eval("mob").ToString() == "Y" ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
          <asp:TemplateField HeaderText="SPASTICITY">
                    <ItemTemplate>
                        <asp:Label ID="lblspac" runat="server" Text='<%#Eval("spac").ToString() == "Y" ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
          <asp:TemplateField HeaderText="PAIN">
                    <ItemTemplate>
                        <asp:Label ID="lblpain" runat="server" Text='<%#Eval("mob").ToString() == "Y" ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
          <asp:TemplateField HeaderText="LIFE AFTER STROKE">
                    <ItemTemplate>
                        <asp:Label ID="lbllas" runat="server" Text='<%#Eval("laf").ToString() == "Y" ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
         <asp:TemplateField HeaderText="FATIGUE">
                    <ItemTemplate>
                        <asp:Label ID="lblfat" runat="server" Text='<%#Eval("fatg").ToString() == "Y" ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
           <asp:TemplateField HeaderText="MESSAGE">
                    <ItemTemplate>
                        <asp:TextBox ID="txtmsg" runat="server" CssClass="form-control" Width="200px" placeholder="TYPE YOUR MESSGAE"></asp:TextBox>
                   <asp:Button ID="btnmsg" runat="server" CssClass="btn btn-sm btn-success" Width="100px" Height="50px" Text="Send" CommandName="Send"   CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                         </ItemTemplate>
                </asp:TemplateField>
    </Columns>
</asp:GridView>
